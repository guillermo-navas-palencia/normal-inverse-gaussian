...
Replacing $\Phi(-\beta\sqrt{t})$ in the integral \eqref{integral_phi} with the expansion \eqref{phi_expansion_1} and interchanging the order of integration and summation, we obtain the alternating series
...
\subsubsection{Expansion $\alpha \to \infty$}
See \cite[\S 27]{Temme2015}
