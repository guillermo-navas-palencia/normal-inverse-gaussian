...
\begin{proposition}
For $x - \mu > 0$, a Fourier cosine transform integral representation in terms of the exponential integral $E_1(x)$ is given by
\begin{equation}
F(x; \alpha, \beta, \mu, \delta) = 1 - \frac{\delta e^{\delta \gamma}}{\pi}\int_0^{\infty} E_1\left((x-\mu)(\sqrt{t^2 + \alpha^2} - \beta)\right) \cos(\delta t) \mathop{dt}.
\end{equation}

A Fourier sine transform integral representation in terms of basic functions is
\begin{equation}
F(x; \alpha, \beta, \mu, \delta) = 1- \frac{e^{\delta \gamma}}{\pi}\int_0^{\infty} \frac{te^{-(x-\mu)\left(\sqrt{t^2 + \alpha^2} - \beta\right)}}{\sqrt{t^2 + \alpha^2}\left(\sqrt{t^2 + \alpha^2} - \beta\right)} \sin(\delta t) \mathop{dt}.
\end{equation}
\end{proposition}
\begin{proof}
\begin{equation*}
\frac{K_1\left(\alpha\sqrt{\delta^2 + z^2}\right)}{\sqrt{\delta^2 + z^2}} = \frac{1}{\alpha z}\int_0^{\infty} e^{-z\sqrt{t^2 + \alpha^2}} \cos(\delta t) \mathop{dt}.
\end{equation*}
\begin{equation*}
F(x; \alpha, \beta, \mu, \delta) = 1 - \frac{\alpha \delta e^{\delta \gamma}}{\pi}\int_{x-\mu}^{\infty} \frac{e^{\beta z}}{\alpha z}\int_0^{\infty} e^{-z\sqrt{t^2 + \alpha^2}} \cos(\delta t) \mathop{dt} \mathop{dz}
\end{equation*}
\begin{equation*}
\int_{x-\mu}^{\infty}\frac{1}{z}e^{-(\sqrt{t^2 + \alpha^2} - \beta)z} \mathop{dz} = E_1\left((x-\mu)(\sqrt{t^2 + \alpha^2} - \beta)\right).
\end{equation*}
\end{proof}
