...
\end{equation}
The latter expansion being more convenient since $\alpha > \gamma$.
...
\subsection{Double-exponential quadrature}
Upper bound $W_0(x)$, for $x > 1$ given in \cite{Hoorfar2008}.
\begin{equation}
W_0(x) \le \log(x)^{\tfrac{\log(x)}{1 + \log(x)}}.
\end{equation}
