...
Since the NIG distribution is a special case of the GH distribution, distributional properties, such as being closed under convolution and infinity divisibility, can also be inferred from results for the GH distribution.
...
\end{equation}
The relation becomes critical to extend the domain of applicability of multiple expansions derived in the next section. Furthermore, it can also help to minimize numerical issues when computing the complementarity cumulative distribution function or survival function.
